...
DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME;
	...
	SELECT 
		...
		ELSE 'Unknown'
	END cst_material_status, -- Normalize marital status value in readable format

		CASE 
			WHEN TRIM(cst_gndr) = 'F' THEN 'Female'
			WHEN TRIM(cst_gndr) = 'M' THEN 'Male'
		ELSE 'Unknown'
	END cst_gndr, -- Normalize gender value in readable format
